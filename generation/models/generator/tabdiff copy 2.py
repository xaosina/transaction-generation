...
class ContinuousDiscreteDiffusionGenerator2(BaseGenerator):
    ...
    def __init__(self, data_conf: LatentDataConfig, model_config: ModelConfig):
        ...
        ## keep the columns order in the data batch
    ...
    def forward(self, x: GenBatch) -> torch.Tensor:
        ...
        loss = self.encoder(hist_data,tgt_data,cond_dict,corrupt_dict)
