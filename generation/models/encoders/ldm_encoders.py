...
class AsyncDiffEncoder(BaseSeq2Seq):
    ...
    def forward(
        ...
        async_t_shedule = adiff4tpp.obtain_noise_schedule(self.async_t_schedule_name)(self.generation_len)
        ...
        a_t_dot = async_t_shedule.derivative(t).unsqueeze(-1).to(target_seq.device) # (bs, L_gen, 1)
    ...
    def generate(
        ...
        async_t_shedule = adiff4tpp.obtain_noise_schedule(self.async_t_schedule_name)(self.generation_len).to(device)
