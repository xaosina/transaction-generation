...
class DeTPPLoss_abs(Module):
    ...
    def forward(self, inputs: GenBatch, outputs: tuple):
        ...
        outputs, presence_scores, loss_latent = outputs
        ...
        return {"loss": self.match_targets(outputs, presence_scores, target_windows)+0.01*loss_latent}
